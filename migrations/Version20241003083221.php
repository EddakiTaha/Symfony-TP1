 ...
 */
final class Version20241003083221 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE episodes (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, duration DATETIME NOT NULL, release_date DATE NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
